        ...
        while opcion != 0:
            ...
            if opcion >=0 and opcion <= 10:
                if opcion == 0:
                    ...
                    # ! CREAR TABLA CORRECTAMENTE COMO DICE ENUNCIADO
                    borrar_sql = "DROP TABLE IF EXISTS Monopatin"
                    sql = "CREATE TABLE Monopatin (_id INTEGER PRIMARY KEY , marca  VARCHAR(30), precio FLOAT NOT NULL, stock INTEGER NOT NULL,UNIQUE(marca))"
